    ...
    <section id="work" className="bg-white py-16 sm:py-24">
      <SiteContainer>
        <div className="grid items-end gap-6 lg:grid-cols-[minmax(0,1.1fr)_minmax(0,0.9fr)] lg:gap-10">
          <div>
            <p className="text-subtitle text-yellow-600">Featured work</p>
            <h2
          ...
          >
            A snapshot of the last twelve months - commercials, music, and
            documentary work shipped for partners we&apos;re proud of.
          </p>
        </div>
        ...
        <div className="mt-14 flex justify-center">
          <a
            href="/work"
            className="inline-flex items-center rounded-full border border-zinc-300 px-7 py-3 text-sm font-semibold tracking-[0.04em] text-zinc-900 uppercase transition-colors hover:border-zinc-900 hover:bg-zinc-900 hover:text-white"
          >
            View all work
          </a>
        </div>
